show_yt_content_new = """  // Tool 2.5: show_yt_content
  server.registerTool(
    "show_yt_content",
    {
...
start_idx = content.find("  // Tool 2.5: list_yt_videos")
end_idx = content.find("  // Tool 3: search_yt_content")

if start_idx != -1 and end_idx != -1:
    new_content = content[:start_idx] + show_yt_content_new + content[end_idx:]
